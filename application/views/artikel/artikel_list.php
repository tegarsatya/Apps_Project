<div class="row" style="margin-bottom: 10px">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('artikel'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <th>Action</th>
            ...
            <td><img src="<?php echo base_url()?>gambar/<?php echo $artikel->gambar ?>" style="width: 50px; height: 50px;"></td>
            <td><?php
                $this->db->where('id_kategori', $artikel->id_kategori);
                $d = $this->db->get('kategori')->row();
             echo $d->kategori ?></td>
